/*
import 'package:night_night_moo/character/character.dart';
import 'package:night_night_moo/character/character_detail_screen.dart';
      ...
      onTap: () {
        Navigator.push(
            ...
            PageRouteBuilder(
                ...
                pageBuilder: (context, _, __) => character_detail_screen(character: characters[0])));
      },
